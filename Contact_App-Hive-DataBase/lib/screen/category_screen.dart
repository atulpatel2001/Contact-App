...
class CategoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () {
                              openDialogBox(index,context,category);
                            },
                          ),
                          IconButton(
                            color: const Color(0xFF00BF8E),
    ...
    */
  Future openDialogBox(int index, BuildContext context, Category category) {
       return  showDialog(
         context: context,
                                 ...
                                 ElevatedButton(
                                   onPressed: () {
                                     if (updateCategoryKey.currentState!.validate()) {
                                       ...
                                       categoryController.updateCategory(Category(name: categoryName),index);
